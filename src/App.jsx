      ...
      <div className='sixth-section' id='sixth-section'>
        ...
        <div className='sixth-section__container container'>
          <div className='sixth-section__left-block'>
            <div className='sixth-section__slider'><SliderServices /></div >
          </div>
      ...
      <div className='footer'>
        <div className='footer__container container'>
          ...
          <div className='footer__social'>
            <a href='https://vk.com/oxygenfront' target="_blank" rel="noopener noreferrer">
              <img src={images.vk} alt='' />
            </a>
            <a href='https://t.me/oxygenfront' target="_blank" rel="noopener noreferrer">
              <img src={images.tg} alt='' />
            </a>
            <a href='https://wa.me/+79995112100?text=urlencodedtext' target="_blank" rel="noopener noreferrer">
